# 🎉 mermkit - Create Diagrams Easily in Your Terminal

## 🚀 Getting Started

Welcome to mermkit! This tool helps you create diagrams using Mermaid directly in your terminal or chat applications like Discord and Slack. You can now visualize ideas quickly and simply, no coding required. Let's get you set up.
...
4. Once the download is complete, follow the installation instructions based on your operating system.
...
3. Drag the mermkit icon into your Applications folder.
4. Eject the mermkit installer from your desktop.

## 🎨 How to Use mermkit

Once installed, using mermkit is straightforward. You can create diagrams by following these steps:

1. Open your terminal.
2. Use the command `mermkit [options] [diagram]` to create your diagram.
3. Replace `[options]` and `[diagram]` with your desired settings and diagram structure based on your needs.
